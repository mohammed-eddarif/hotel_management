...
<form action="<%=request.getContextPath()%>/ReceptionistEditSalleServlet" method="post">
    <div class="space-y-4 mt-5 p-6">

        <input type="hidden" name="id_salle" id="id_salle" value="${salle.id_salle}">

        <div class="mb-6">
            <label for="id_nbr_places" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Places
                Number</label>
            <input type="text" id="id_nbr_places" name="nbr_places" value="${salle.nbr_places}"
        ...
        <div class="mb-6">
            ...
            <input type="text" name="floor" id="id_floor" value="${salle.floor}"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>

        <div class="mb-6">
            <label for="id_price_per_day" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price Per Day</label>
            <input type="text" id="id_price_per_day" name="price_per_day" value="${salle.price_per_day}"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
