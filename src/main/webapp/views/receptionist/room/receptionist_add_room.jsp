...
<a href="<%=request.getContextPath()%>/ReceptionistHomeServlet"><button class="m-6 px-6 py-3 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold rounded-xl">Back to Home</button></a>
...
<form action="AddRoomServlet" method="post">
    <div class="space-y-4 mt-5 p-6">
        ...
        <div class="mb-6">
            <label for="id_price_per_day" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Base
                input</label>
