...
<nav class="px-6 py-6 flex justify-between items-center border-b border-gray-200">
    ...
    <div class="space-x-6">
        ...
        <a href="#" class="text-xl font-semibold hover:text-gray-500">Home</a>
        <a href="#" class="text-lg font-semibold hover:text-gray-500">Manage Pools</a>
        <a href="#" class="text-lg font-semibold hover:text-gray-500">Manage Night-Club</a>
        <a href="#" class="text-lg font-semibold hover:text-gray-500">Manage Terasse</a>
        <a href="#" class="text-lg font-semibold hover:text-gray-500">Manage Table</a>
        <a href="#" class="px-6 py-3 text-lg font-semibold bg-red-500 text-white rounded-xl hover:bg-red-700">Log out</a>
