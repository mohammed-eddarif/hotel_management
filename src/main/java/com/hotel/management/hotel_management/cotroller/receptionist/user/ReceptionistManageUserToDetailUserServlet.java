...
@WebServlet(name = "ReceptionistManageUserToDetailUserServlet", value = "/ReceptionistManageUserToDetailUserServlet")
public class ReceptionistManageUserToDetailUserServlet extends HttpServlet {
    @Override
