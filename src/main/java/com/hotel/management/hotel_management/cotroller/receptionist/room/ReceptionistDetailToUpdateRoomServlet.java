...
@WebServlet(name = "ReceptionistDetailToUpdateRoomServlet", value = "/ReceptionistDetailToUpdateRoomServlet")
public class ReceptionistDetailToUpdateRoomServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("views/receptionist/room/receptionist_edit_room.jsp").forward(request,response);
